...
export default function Hero() {
  return (
    <div className="relative bg-[url('/page/shallow-focus-shot-african-child-learning-school.jpg')] flex  items-center bg-cover bg-center bg-no-repeat w-full h-[91.3rem]">
